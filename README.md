...
|   | [Credit scoring](https://github.com/an-karpov/Credit_scoring) | Прогноз отсрочки по кредиту по характеристикам клиента | Python, xgboost, hyperopt, pandas, plotly, seaborn, numpy. | Классификация, бустинг, Bayesian Optimization, Steamlit  || 
